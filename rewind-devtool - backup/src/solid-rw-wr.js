...
export function srInit() {
  // THIS LISTENS FOR STATE CHANGE EVENTS BASED ON MY REPLACING createSignal. This build out my state stack, but in robbie's version this wont be used.
...
function trackStateChange(e) {
  console.log("!!!!!!! DOES THIS EVER HAPPEN !!!!!!!", e.detail);
